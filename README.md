...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dev-api.stackbit.com/pull/60376cfa4ffded0016470657
...
To start editing your site, you can use the Sanity interface at https://gs-76cfa.sanity.studio/.
...
Generated at `2021-02-25T09:25:37.804Z` by Stackbit version `0.3.50`.